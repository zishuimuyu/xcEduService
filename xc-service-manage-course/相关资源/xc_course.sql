/*
 ...
 Source Host           : 49.235.109.97:3306
...
CREATE TABLE `category`  (
  `id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '主键/课程id',
...
INSERT INTO `course_pic` VALUES ('4028e581617f945f01617f9dabc40000', 'group1/M00/00/00/wKgZhV2ix0yALU5UAADqBMhMZWA376.png');
...
CREATE TABLE `teachplan`  (
  `id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '课程计划id',
  `pname` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '课程计划名称',
  `parentid` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '父级节点id',
