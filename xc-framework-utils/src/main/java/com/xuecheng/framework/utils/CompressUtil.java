...
public class CompressUtil {
     ...
     * @throws ZipException 压缩文件有损坏或者解压缩失败抛出
     */
    public static File[] unZip(File zipFile, String path, String passwd) throws ZipException {
     ...
     * @param savePath    压缩文件存放路径
     * @param isCreateDir 是否在压缩文件里创建目录,仅在压缩文件为目录时有效,如果为false,将直接压缩目录下文件到压缩文件.
     * @param passwd      压缩使用的密码,为 NUll 表示不加密
     * @return 最终的压缩文件存放的绝对路径, 如果为null则说明压缩失败.
     */
    public static String zip(String src, String savePath, boolean isCreateDir, String passwd) {
        File srcFile = new File(src);
        savePath = buildDestinationZipFilePath(srcFile, savePath);
